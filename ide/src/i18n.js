...
const EN = {
  ...
  "assistant.capabilities.open": "Open Skills and MCP menu",
  "assistant.capability.skills": "Skills",
  "assistant.capability.skillsSub": "Skills",
  "assistant.capability.mcp": "MCP",
  "assistant.capability.mcpSub": "Services",
  ...
  "model.thinking.reason.gpt56": "GPT-5.6 follows the gateway's public none/low/medium/high/xhigh/max reasoning_effort tiers.",
  ...
  "login.title": "Welcome to Michael IDE",
  ...
  "menu.about": "About",
  "menu.aboutMsg": "Michael IDE — a macOS-style editor with a built-in AI assistant",
...
const ZH_CN = {
  ...
  "assistant.capabilities.open": "打开 Skills 和 MCP 菜单",
  "assistant.capability.skills": "Skills",
  "assistant.capability.skillsSub": "技能",
  "assistant.capability.mcp": "MCP",
  "assistant.capability.mcpSub": "服务",
  "assistant.mode.agent": "Agent",
  "assistant.mode.plan": "Plan",
  "assistant.mode.chat": "Chat",
  "assistant.mode.auto": "Auto",
  ...
  "model.thinking.reason.gpt56": "GPT-5.6 系列按网关公开档位 none/low/medium/high/xhigh/max 调整 reasoning_effort。",
  ...
  "menu.about": "关于",
  "menu.aboutMsg": "Michael IDE — 一款内置 AI 助手的 macOS 风格代码编辑器",
...
const JA = {
  ...
  "assistant.capabilities.open": "Skills と MCP メニューを開く",
  "assistant.capability.skills": "Skills",
  "assistant.capability.skillsSub": "スキル",
  "assistant.capability.mcp": "MCP",
  "assistant.capability.mcpSub": "サービス",
  "assistant.mode.agent": "Agent",
  "assistant.mode.plan": "Plan",
  "assistant.mode.chat": "Chat",
  "assistant.mode.auto": "Auto",
  ...
  "menu.about": "情報",
  "menu.aboutMsg": "Michael IDE — AI アシスタント内蔵の macOS 風コードエディター",
