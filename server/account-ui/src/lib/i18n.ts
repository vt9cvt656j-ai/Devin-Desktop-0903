...
const EN = {
  ...
  navDevices: "Devices",
  navModels: "Model routes",
  navReferral: "Referrals",
  navChangelog: "Update log",

  navCommission: "Commission",
  navInvite: "Invite",
  navReferrals: "Referrals",
  navSettlements: "Settlements",
  settlementsLede: "Commission that has been settled, and how.",
  settlementsEmptyTitle: "Nothing has been settled yet",
  settlementsEmptyBody:
    "Commission appears here once it has been approved, or immediately if automatic settlement is switched on.",
  settlementsTotal: "Settled in total",
  settlementsAuto: "credited to your balance",
  settlementsManual: "approved by an administrator",
  settlementsReversed: "cancelled — the purchase was refunded",
  ...
  withdrawPaidNow: "Sent. The transfer is on its way to your Stripe account.",
  showingPage: "Page {page} of {pages}",
  navWithdraw: "Withdraw",

  referralsLede: "The people you brought in, and what each has earned you.",
  referralsEmptyTitle: "Nobody has joined through you yet",
  referralsEmptyBody: "Share your code or link from the Invite screen. Anyone who signs up with it appears here.",
  referralsUntil: "earning until {date}",
  referralsEnded: "window closed",

  withdrawLede: "Request payment of commission that has been approved.",
  withdrawAvailable: "Available to withdraw",
  withdrawPending: "Not yet approved",
  withdrawPendingNote: "Commission is approved by an administrator before it can be withdrawn.",
  withdrawAmount: "Amount (USD)",
  withdrawMethod: "Pay me by",
  withdrawAccount: "Send it to",
  withdrawAccountHint: "Account, address or number",
  withdrawSubmit: "Request payment",
  withdrawHow: "Minimum {min} per request.",
  withdrawTooLittle: "You need at least {min} available before you can request a payment.",
  withdrawBadAmount: "Enter an amount.",
  withdrawSubmitted: "Requested. You will be paid manually — see below for its status.",
  withdrawFailed: "Could not send that request.",
  withdrawNone: "No requests yet.",
  withdrawManual: "Payments are sent by hand, not automatically. A request stays pending until an administrator has actually paid it and marked it so.",
  withdrawQrAdd: "Attach a payment QR",
  withdrawQrChange: "Replace QR",
  withdrawQrRemove: "Remove",
  withdrawQrTooBig: "That image is too large. Pick one under 4 MB.",
  withdrawMethod_alipay: "Alipay",
  withdrawMethod_wechat: "WeChat Pay",
  withdrawMethod_bank: "Bank transfer",
  withdrawMethod_paypal: "PayPal",
  withdrawStatus_pending: "Pending",
  withdrawStatus_paid: "Paid",
  withdrawStatus_rejected: "Rejected",

  referral: "Referrals",
  referralLede: "Invite people with your own code or link, and earn on what they spend.",
  referralFailed: "Could not load your referral details just now.",
  referralLockedTitle: "Referrals are not switched on for this account",
  referralLockedBody:
    "Referring is enabled per account by an administrator. Ask them to switch it on and your code and link will appear here.",
  referralCode: "Your invite code",
  referralLink: "Your invite link",
  referralHow:
    "Anyone who signs up through your link, or enters your code, is credited to you — you earn {rate}% of what they pay for the next {days} days. These are the terms for people who join from now on; anyone already invited keeps the terms they joined under.",
  referralPaused:
    "The referral programme is paused right now, so new sign-ups will not be credited until it is switched back on. People you already invited are unaffected.",
  referralInvited: "People invited",
  referralPending: "Awaiting settlement",
  referralSettled: "Settled",
  referralCopy: "Copy",
  referralCopied: "Copied",
  referralPayout:
    "Commissions are raised automatically when someone you invited pays, and settled by an administrator.",
  ...
  tabCredits: "Credits",
  tabRedeem: "Redeem",
  referralBound: "Invite code applied — the person who invited you is now credited for your purchases.",
  ...
  paidSubtitle: "Here is what was added to your account.",
  paidSettling: "Confirming with Stripe — this takes a moment.",
  paidPending: "Payment received. It is being credited; your balance will update shortly.",
  paidPlan: "Plan",
  paidQuota: "Monthly quota",
  paidUntil: "Active until",
  paidProduct: "Product",
  paidCreditsAdded: "Credit added",
  paidBalance: "Wallet balance",
  paidCharged: "Charged",
  paidGoNow: "Go to my account",
  paidReturning: "Returning to your account in {n}s",
