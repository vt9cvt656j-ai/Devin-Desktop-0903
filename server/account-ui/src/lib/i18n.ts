...
const EN = {
  ...
  codeHostsLede:
    "Link an account and its repositories become available in the editor — type @github: or @gitee: to pick one.",
  connect: "Connect",
  connecting: "Opening…",
  disconnect: "Disconnect",
  connectedAs: "Connected as",
  notConfigured: "Not available on this server yet",
...
const ZH: Dict = {
  ...
  codeHosts: "代码托管",
  codeHostsLede: "连接账号后，仓库会直接出现在编辑器里 —— 输入 @github: 或 @gitee: 即可选择。",
  connect: "连接",
  connecting: "正在打开…",
  disconnect: "断开",
  connectedAs: "已连接",
  notConfigured: "本服务器尚未开放",
