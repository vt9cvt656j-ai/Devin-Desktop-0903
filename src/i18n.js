...
const EN = {
  ...
  "feature.settings.fullAuto.label": "Fully unrestricted",
  "feature.settings.fullAuto.hint": "Nothing is ever asked, including destructive commands and deletes. Deleting a folder is remove_dir_all: no trash, no backup, and this app has no undo entry point — one wrong call is permanent. It applies to scheduled runs too, so it can delete with nobody watching.",
  "feature.settings.fullAutoOn": "Fully unrestricted: nothing will be asked",
  "feature.settings.fullAutoOff": "Back to asking before destructive actions",
  ...
  "feature.settings.approvalOff": "Approval disabled, full automation restored",
...
const ZH_CN = {
  ...
  "feature.settings.approval.hint": "开启后，写文件、删除、运行命令、操控电脑等有副作用操作前会先问你。",
  "feature.settings.fullAuto.label": "完全放开",
  "feature.settings.fullAuto.hint": "任何操作都不再问你，包括高危命令和删除。删目录在系统侧是 remove_dir_all：没有回收站、没有备份，这个软件里也没有撤销入口——一次误判就是永久丢失。定时任务同样适用，也就是说没人看着的时候它也能删。",
  "feature.settings.fullAutoOn": "已完全放开：任何操作都不再询问",
  "feature.settings.fullAutoOff": "已恢复：高危操作前会先问你",
  ...
  "feature.settings.approvalOff": "已关闭审批，恢复全自动",
...
const JA = {
  ...
  "feature.settings.fullAuto.label": "完全に制限なし",
  "feature.settings.fullAuto.hint": "破壊的なコマンドや削除を含め、一切確認しません。フォルダ削除は remove_dir_all で、ゴミ箱もバックアップも取り消しもありません。定時実行にも適用されます。",
  "feature.settings.fullAutoOn": "完全に制限なし：確認しません",
  "feature.settings.fullAutoOff": "破壊的な操作の前に確認します",
