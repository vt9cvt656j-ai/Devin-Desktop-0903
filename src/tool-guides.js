...
const TOOL_METADATA = Object.freeze({
  ...
  academic_search: {
    category: 'research', use_cases: ['学术论文检索', '研究文献查找'], triggers: ['需要学术引用', '查找论文'],
    example_call: "academic_search(query='transformer attention mechanisms')",
    priority: 'medium',
    usage_note: '【何时用】查找学术论文、研究文献时。【vs 替代】通用技术搜索用 web_search；代码实现用 github_search。【何时不用】不需要学术引用时。'
  },
  developer_community_search: {
  ...
  pubmed_search: { category: 'research', use_cases: ['生物医学文献检索'], triggers: ['医学研究', '生物信息'], example_call: "pubmed_search(query='CRISPR gene editing')", priority: 'low', usage_note: '【何时用】检索 PubMed 生物医学文献。【vs 替代】通用学术用 academic_search。' },
  arxiv_search: { category: 'research', use_cases: ['arXiv 预印本搜索'], triggers: ['最新研究论文', 'AI/ML 前沿'], example_call: "arxiv_search(query='diffusion model sampling')", priority: 'medium', usage_note: '【何时用】搜索 arXiv 最新研究预印本。【vs 替代】已发表论文用 academic_search。' },
  crossref_search: { category: 'research', use_cases: ['DOI/引用元数据检索'], triggers: ['查找论文引用', 'DOI 解析'], example_call: "crossref_search(query='10.1145/reactive')", priority: 'low', usage_note: '【何时用】通过 DOI 查找论文引用元数据。【vs 替代】全文搜索用 academic_search。' },
  openalex_search: { category: 'research', use_cases: ['开放学术元数据搜索'], triggers: ['学术数据分析', '机构/作者检索'], example_call: "openalex_search(query='machine learning')", priority: 'low', usage_note: '【何时用】搜索开放学术图谱数据。【vs 替代】论文全文用 academic_search/arxiv_search。' },
  ...
  reddit_search: { category: 'research', use_cases: ['Reddit 帖子搜索'], triggers: ['社区讨论', '用户经验'], example_call: "reddit_search(query='best Rust web framework')", priority: 'medium', usage_note: '【何时用】搜索 Reddit 上的讨论帖。【vs 替代】多源聚合用 developer_community_search。' },
  ...
  color_search: { category: 'research', use_cases: ['配色方案搜索'], triggers: ['UI 配色', '颜色值查找'], example_call: "color_search(query='tailwind blue')", priority: 'low', usage_note: '【何时用】搜索配色方案/颜色值。' },
  lobsters_search: { category: 'research', use_cases: ['Lobsters 技术讨论搜索'], triggers: ['小众技术社区'], example_call: "lobsters_search(query='NixOS')", priority: 'low', usage_note: '【何时用】搜索 Lobsters 技术社区讨论。【vs 替代】主流社区用 hackernews_search。' },
  ...
  css_tricks_search: { category: 'research', use_cases: ['CSS-Tricks 文章搜索'], triggers: ['CSS 技巧', '前端布局'], example_call: "css_tricks_search(query='flexbox vs grid')", priority: 'low', usage_note: '【何时用】搜索 CSS-Tricks 的 CSS/前端文章。' },
  codepen_search: { category: 'research', use_cases: ['CodePen 代码示例搜索'], triggers: ['前端代码示例', 'UI demo'], example_call: "codepen_search(query='dark mode toggle')", priority: 'low', usage_note: '【何时用】搜索 CodePen 上的前端代码示例。' },
  dribbble_search: { category: 'research', use_cases: ['Dribbble 设计作品搜索'], triggers: ['UI 设计参考', '视觉灵感'], example_call: "dribbble_search(query='dashboard design')", priority: 'low', usage_note: '【何时用】搜索 Dribbble 上的设计作品获取灵感。' },
  ...
  producthunt_search: { category: 'research', use_cases: ['Product Hunt 产品搜索'], triggers: ['新产品发现', '竞品分析'], example_call: "producthunt_search(query='AI coding assistant')", priority: 'low', usage_note: '【何时用】搜索 Product Hunt 上的新产品。' },
  freecodecamp_search: { category: 'research', use_cases: ['freeCodeCamp 教程搜索'], triggers: ['编程学习', '入门教程'], example_call: "freecodecamp_search(query='JavaScript closures')", priority: 'low', usage_note: '【何时用】搜索 freeCodeCamp 的编程学习资源。' },
  ...
  smzdm_search: { category: 'research', use_cases: ['什么值得买商品搜索'], triggers: ['购物优惠', '商品评测'], example_call: "smzdm_search(query='机械键盘')", priority: 'low', usage_note: '【何时用】搜索什么值得买上的商品优惠/评测。非技术工具。' },
  xianyu_search: { category: 'research', use_cases: ['闲鱼二手商品搜索'], triggers: ['二手交易', '比价'], example_call: "xianyu_search(query='MacBook Pro')", priority: 'low', usage_note: '【何时用】搜索闲鱼二手商品。非技术工具。' },
  zhuanzhuan_search: { category: 'research', use_cases: ['转转二手商品搜索'], triggers: ['二手交易', '比价'], example_call: "zhuanzhuan_search(query='iPhone')", priority: 'low', usage_note: '【何时用】搜索转转二手商品。非技术工具。' },
  ...
  db_query: { category: 'data_layer', use_cases: ['执行 SQL 查询', '数据库结构检查'], triggers: ['查询数据', '检查 schema'], example_call: "db_query(driver='sqlite', query='SELECT * FROM users')", priority: 'high', usage_note: '【何时用】执行 SQL 查询/检查数据库结构。【vs 替代】表结构变更用 db_migrate。【注意】查询失败后不要无限重试同一条 SQL。' },
  db_migrate: { category: 'data_layer', use_cases: ['数据库迁移', '表结构变更'], triggers: ['需要修改表结构'], example_call: "db_migrate(script='./migrations/add_users.sql')", priority: 'high', usage_note: '【何时用】执行数据库迁移/DDL。【vs 替代】查询用 db_query。' },
  backup_database: { category: 'data_layer', use_cases: ['数据库备份'], triggers: ['重大变更前'], example_call: "backup_database(source='app.db', dest='./backups/app.backup')", priority: 'high', usage_note: '【何时用】变更前备份数据库。【注意】永远在 db_migrate 前执行。' },
  ...
  game_scaffold: { category: 'generation', use_cases: ['游戏项目脚手架'], triggers: ['新建游戏项目'], example_call: "game_scaffold(engine='threejs', name='space-runner')", priority: 'medium', usage_note: '【何时用】快速搭建游戏项目骨架。' },
  ...
  live_markets: { category: 'location', use_cases: ['实时市场数据'], triggers: ['汇率/股价查询'], example_call: "live_markets(kind='exchange_rate', base='USD', quote='CNY')", priority: 'low', usage_note: '【何时用】查询实时汇率/股票等市场数据。' },
  live_flights: { category: 'location', use_cases: ['实时航班查询'], triggers: ['航班状态'], example_call: "live_flights(latitude=37.77, longitude=-122.42)", priority: 'low', usage_note: '【何时用】查询附近实时航班信息。' },
  road_environment: { category: 'location', use_cases: ['路况信息查询'], triggers: ['出行规划'], example_call: "road_environment(kind='overview', near='current')", priority: 'low', usage_note: '【何时用】查询路况/交通信息。' },
  track_shipment: { category: 'location', use_cases: ['快递追踪'], triggers: ['查物流状态'], example_call: "track_shipment(tracking_number='TRACKING')", priority: 'low', usage_note: '【何时用】追踪快递/包裹物流状态。' },
  shop_catalog: { category: 'location', use_cases: ['Shopify 商店目录读取'], triggers: ['查看商店商品'], example_call: "shop_catalog(query='keyboard', url='https://shop.example.com')", priority: 'low', usage_note: '【何时用】读取 Shopify 商店的商品目录。' },
